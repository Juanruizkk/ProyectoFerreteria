...
export default function EditAccountConfigForm({ config, onSubmit, onCancel }) {
  ...
  useEffect(() => {
    if (config) {
      setFormData({
        ...
        montoLimite: config.montoLimite.toString(),
      });
    }
  }, [config]);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Editar Configuración de Cuenta Corriente</CardTitle>
        <CardDescription>
          Modifique los datos de la configuración de cuenta corriente.
        </CardDescription>
      </CardHeader>
      <CardContent>
