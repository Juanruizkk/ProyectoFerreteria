...
export default function ClientTable({ clientes, onViewDetails, onEdit, onDelete }) {
        ...
        <TableBody>
          {clientes.map((cliente) => (
            <TableRow key={cliente.idCliente}>
              <TableCell className="font-medium">{getNombreCompleto(cliente)}</TableCell>
              ...
              <TableCell className="text-right">
                <div className="flex justify-end gap-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => onEdit(cliente.idCliente)} title="Editar">
                    <Pencil className="h-4 w-4" />
                  </Button>
                  <Button variant="ghost" size="sm" onClick={() => onDelete(cliente.idCliente)} title="Eliminar">
